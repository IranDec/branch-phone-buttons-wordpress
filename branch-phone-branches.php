...
function bpb_display_buttons_html($is_shortcode = false) {
    ...
    echo '<div id="bpb-phone-modal" class="bpb-modal" style="display:none;">
        ...
        <div class="bpb-modal-body">
            ...
            <div class="bpb-copy-box">
                ...
                <button class="bpb-copy-btn" onclick="bpb_copy_to_clipboard(\'bpb-phone-number-display\', this)">کپی <svg viewBox="0 0 24 24" width="16" height="16"><path fill="currentColor" d="M16 1H4c-1.1 0-2 .9-2 2v14h2V3h12V1zm3 4H8c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h11c1.1 0 2-.9 2-2V7c0-1.1-.9-2-2-2zm0 16H8V7h11v14z"/></svg></button>
            </div>
    ...
    echo '<div id="bpb-email-modal" class="bpb-modal" style="display:none;">
        ...
        <div class="bpb-modal-body">
            ...
            <div class="bpb-copy-box">
                ...
                <button class="bpb-copy-btn" onclick="bpb_copy_to_clipboard(\'bpb-email-address-display\', this)">کپی <svg viewBox="0 0 24 24" width="16" height="16"><path fill="currentColor" d="M16 1H4c-1.1 0-2 .9-2 2v14h2V3h12V1zm3 4H8c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h11c1.1 0 2-.9 2-2V7c0-1.1-.9-2-2-2zm0 16H8V7h11v14z"/></svg></button>
            </div>
    ...
    echo '<script>
        ...
        function bpb_copy_to_clipboard(elementId, btn) {
